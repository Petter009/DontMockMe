...
namespace Mocking
{
    ...
    public class MockTests
    {
        ...
        public void CanCalulateAverageWeeklySaleryPerEmployee()
        {
            ...
            double tempResult = (1000 * 42) + (750 * 42) + (500 * 42);
            ...
            foreach (var e in employees)
            {
                averageWeeklySalary += e.CalculateAverageWeeklySalary(hours, e.Wage, employees.Count);
            }
            double expectedResult = tempResult / employees.Count;
